          ...
          <div className="grid items-center gap-16 md:grid-cols-[1.1fr,0.9fr]">
            <div className="space-y-10">
              <div className="flex flex-col gap-6 text-center md:text-left">
                <div className="inline-flex items-center gap-2 self-center md:self-start rounded-full border border-primary/20 bg-primary/15 px-4 py-2 text-sm font-medium text-primary shadow-soft">
